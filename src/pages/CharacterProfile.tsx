        ...
        {sectionVisibility.coreIdentity && (
          <section className="mb-8 fade-in">
            <div className="flex items-center justify-between mb-6 slide-in-left">
              <h3 className="text-2xl font-bold mono-font text-foreground flex items-center gap-2 hover-lift">
                <User className="w-6 h-6 text-accent pulse-glow" />
                Core Identity
              </h3>
            ...
            <Card className="tech-card-glow">
              ...
              <CardContent className="space-y-4">
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm">Related characters will be displayed here</p>
                  <p className="text-xs">Mini-profile cards with relationships</p>
                </div>
              </CardContent>
            </Card>
          </div>
